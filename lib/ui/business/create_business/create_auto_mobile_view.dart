...
class CreateAutoMobileView extends ConsumerStatefulWidget {
  const CreateAutoMobileView({super.key, required this.businessId});

  final String businessId;

  @override
  ConsumerState<CreateAutoMobileView> createState() => _CreateAutoMobileView();
}

class _CreateAutoMobileView extends ConsumerState<CreateAutoMobileView> {
...
// Form Variables
  String selectedBusinessType = 'Car Service';
  ...
  onBusinessFormSubmit() async {
    ...
    if (_formKey.currentState!.validate()) {
      ...
      if (imageFile != null) {
        ...
        final storageRef_ =
            storageRef.ref().child('autoMobiles/$newImageFile.jpg');
  ...
  deleteExistingImage(String? imageName) async {
    await storageRef.ref().child('autoMobiles/$imageName').delete();
  }
