...
class CreateFinancialProfessionalsView extends ConsumerStatefulWidget {
  const CreateFinancialProfessionalsView({super.key, required this.businessId});

  final String businessId;

  @override
  ConsumerState<CreateFinancialProfessionalsView> createState() =>
      _CreateFinancialProfessionalsView();
}

class _CreateFinancialProfessionalsView
    extends ConsumerState<CreateFinancialProfessionalsView> {
...
// Form Variables
  String selectedBusinessType = 'Insurance Agencies';
  ...
  onBusinessFormSubmit() async {
    ...
    if (_formKey.currentState!.validate()) {
      ...
      if (imageFile != null) {
        ...
        final storageRef_ =
            storageRef.ref().child('financialProfessional/$newImageFile.jpg');
      ...
      if (widget.businessId.isEmpty) {
        await firestore
            .collection('financialProfessional')
            .add(data)
  ...
  deleteExistingImage(String? imageName) async {
    await storageRef.ref().child('financialProfessional/$imageName').delete();
  }
                        ...
                        Column(
                          ...
                          children: [
                            ...
                            DropdownButton(
                              ...
                              items: financialProfessionals.map((value) {
